...
namespace ailab_super_app.Migrations
{
    ...
    [Migration("20260120194739_AddFirebaseAuthenticationSupport")]
    partial class AddFirebaseAuthenticationSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ailab_super_app.Models.Avatar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("avatars", "app");
                });

            modelBuilder.Entity("ailab_super_app.Models.BugReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("bug_reports", "app");
                });

            modelBuilder.Entity("ailab_super_app.Models.ButtonPressLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PressedAt");

                    b.HasIndex("RoomId");

                    b.ToTable("button_press_logs", "app");
                });
            ...
            modelBuilder.Entity("ailab_super_app.Models.DoorState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ailab_super_app.Models.MonthlyScoreSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("monthly_score_snapshots", "app");
                });
            ...
            modelBuilder.Entity("ailab_super_app.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ailab_super_app.Models.ReportAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("report_audit_logs", "app");
                });
            ...
            modelBuilder.Entity("ailab_super_app.Models.ReportRequestProject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReportRequestId", "ProjectId")
                        .IsUnique();

                    b.ToTable("report_request_projects", "app");
                });
            ...
            modelBuilder.Entity("ailab_super_app.Models.RfidReader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RoomId", "Location");

                    b.ToTable("rfid_readers", "app");
                });
            ...
            modelBuilder.Entity("ailab_super_app.Models.ScoreHistory", b =>
                {
                    ...
                    b.Property<decimal>("PointsChanged")
                        .HasPrecision(18, 4)
            ...
            modelBuilder.Entity("ailab_super_app.Models.TaskItem", b =>
                {
                    ...
                    b.Property<DateTime?>("ScoreAssignedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("ScoreCategory")
                        .HasColumnType("integer");

                    b.Property<bool>("ScoreProcessed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ailab_super_app.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("MigratedToFirebaseAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ailab_super_app.Models.UserAvatar", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ailab_super_app.Models.BugReport", b =>
                {
                    b.HasOne("ailab_super_app.Models.User", "ReportedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ailab_super_app.Models.ButtonPressLog", b =>
                {
                    b.HasOne("ailab_super_app.Models.PhysicalButton", "Button")
                        .WithMany()
            ...
            modelBuilder.Entity("ailab_super_app.Models.Report", b =>
                {
                    ...
                    b.HasOne("ailab_super_app.Models.ReportRequest", "ReportRequest")
            ...
            modelBuilder.Entity("ailab_super_app.Models.ReportAuditLog", b =>
                {
                    b.HasOne("ailab_super_app.Models.User", "PerformedByUser")
                        .WithMany()
                        .HasForeignKey("PerformedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ailab_super_app.Models.Report", "Report")
                        .WithMany()
            ...
            modelBuilder.Entity("ailab_super_app.Models.ReportRequest", b =>
                {
                    b.HasOne("ailab_super_app.Models.User", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ailab_super_app.Models.UserAvatar", b =>
                {
                    b.HasOne("ailab_super_app.Models.Avatar", "Avatar")
                        .WithMany()
                    ...
                    b.HasOne("ailab_super_app.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("ailab_super_app.Models.UserAvatar", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
